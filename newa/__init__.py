...
class ErrataTool:
    ...
    def add_comment(self, erratum_id: str, comment: str) -> JSON:
        # curl --globoff -s --insecure -u a:b --negotiate
        # "https://errata.devel.redhat.com//api/v1/erratum/$errata/add_comment"
        # --request POST \ --data-urlencode "comment@$comment"
        print(f'Adding comment to erratum {erratum_id}:\n{comment}')
...
class IssueHandler:  # type: ignore[no-untyped-def]
    ...
    def refresh_issue(self, action: IssueAction, issue: Issue) -> bool:
        """ Update NEWA identifier of issue.
            Returns True when the issue had been modified."""
